const stories = [
  ...
  readTime: "50 min",
  trending: true,
  excerpt: "For 214 years, the universe had been silent. Then, on the 1,800th day of her posting, Mara Voss watched a flat green line move — and nothing would ever be the same again.",
  image: "https://images.unsplash.com/photo-1628093218069-0d095423e463?w=800&q=80",
  cover: {
    image: "https://images.unsplash.com/photo-1628093218069-0d095423e463?w=1920&q=80"
  },
  content: `The universe had been silent for 214 years.

Not silent in the way forests go quiet before a storm — that kind of silence still breathes. This was the silence of a room after everyone has left and no one is coming back. Scientists called it the Great Withdrawal. Poets called it the Dimming. Children who grew up in the colony ships didn't call it anything. To them, it was simply the shape of the world.

Mara Voss was thirty-one years old and had never seen Earth except in photographs.

She sat in the signal monitoring station on the outer ring of Helix-7 — the seventh and last operational colony vessel still threading its way through the dark between stars — with her headset on and her coffee going cold. The station smelled of recycled air and old circuitry. A strip of yellow light ran along the ceiling, flickering every forty seconds with a reliability that made it somehow worse than total darkness. She had stopped noticing it two years ago.

Her job was simple in the way that the most unbearable jobs always are: listen. Record. Report if anything changes.

Nothing ever changed.

Helix-7 was carrying 14,000 people toward Kepler-442b, a planet 1,200 light-years from a star called Sol that nobody aboard had ever seen with their own eyes. The journey had begun with six ships. One had suffered catastrophic pressure failure near the Oort Cloud. Two others had simply gone quiet — no explosion, no distress signal, just a slow fade of their transponder pulses until there was nothing. A fourth had turned back, though no one spoke of why. The fifth had made contact with Helix-7 approximately sixty years ago, a brief, strange message that said only: Don't follow the light on the port side. We made that mistake. Then silence.

Helix-7 carried on.

Mara pressed two fingers against her left temple and stared at the waveform display — a flat green line, the same flat green line it had been for the eighteen hundred days of her posting. Her predecessor, a tall Ghanaian engineer named Owusu, had warned her before his retirement cycle: "The line will make you philosophical, then it will make you religious, then it will make you strange. Survive the strange and you'll be fine."

She was already in the strange.

She was thinking about her grandmother's voice — a voice she'd never heard, only read transcripts of — when the line moved.

Not much. A tremor, really. A ripple, like a stone dropped into still water.

Mara's hand shot forward and hit the record trigger before her brain had fully processed what her eyes were seeing. Protocol first. Understand later. Her training had made that sequence instinctive.

The ripple came again. Then again. Then, unmistakably, it organized itself into a pattern.

Short. Short. Long. Short. Short. Long.

Mara stopped breathing.

She had studied every form of cosmic interference in her certification years. Pulsar bursts. Magnetar flares. The harmonic resonance of gas giants. Instrument decay mimicking signal. None of them — none of them — produced a repeating pattern like that. Repeating patterns were the one thing nature refused to do reliably. Repeating patterns were the first, oldest, most sacred signature of intention.

Someone was trying to talk to them.
...
He was adding a small notation near the current position marker when Mara burst through his door without knocking, which was the single most alarming thing anyone could do on a colony ship, where privacy was the last genuine luxury remaining.

"Signal," she said, and her voice had the particular thinness of someone trying to sound calm while standing in a fire. "Repeating. Patterned. Not instrument decay."

Yusuf set his pen down with perfect deliberateness.

"Source direction?"

"Ahead of us. Roughly thirty degrees above the ecliptic plane. But Yusuf—" She paused. "It's not coming from Kepler-442b."

He looked at his map. His finger traced the ship's projected course, then slid thirty degrees upward along the paper and stopped at a region he had marked years ago with a small red circle and the letters: NE — unknown mass, non-catalogued.

NE. Navigation Exception. His personal shorthand for things the instruments registered but couldn't explain.

"How long has it been transmitting?" he asked.

"I don't know. It could have been going for centuries and we were just too far out of alignment to catch it. Or it started six hours ago."

"Or," said Yusuf quietly, "it started the moment we entered range."

The silence between them had weight.

"You think something out there noticed us?" Mara asked.

Yusuf looked at the red circle on his map. He had drawn it eleven years ago because the gravitational readings in that region had been subtly, persistently wrong — not wrong enough to report, just wrong enough to make a careful man nervous. He had told no one about it. He had been waiting to understand it before he spoke.

He picked his pen back up.

"I think," he said, "that we should go see what it is before we tell the Captain."

Mara stared at him. "That's completely against protocol."

"Yes."

"The Captain will have us both reassigned."

"Probably."

"Why?"

Yusuf added one more notation to his map — a thin line extending from Helix-7's current position toward the red circle — and then rolled the whole map up with the careful reverence of a man handling something irreplaceable.

"Because the last time someone reported a signal anomaly on a colony ship," he said, "the Captain at the time went to the committee, the committee convened a panel, the panel issued a directive, the directive triggered a mandatory psychological assessment for the reporting crew member, and by the time anyone actually looked at the data, the signal had been gone for forty years."

He tucked the map under his arm.
...
It was a structure. And it was enormous.

The numbers the instruments returned were so large that Mara ran the calculation four times, changing the units each time, as if the absurdity might resolve itself into something manageable. It didn't. The object was approximately 800 kilometers across — roughly the width of France and Germany placed side by side — and its surface, insofar as it had a surface, read as metallic. Not naturally metallic. Not a nickel-iron asteroid or a metallic planetesimal. The spectrographic signature was complex in a way that natural formations never were: dozens of distinct alloys, some of which matched nothing in the ship's materials database, arranged in patterns that repeated at multiple scales.

"It's manufactured," Mara said.

Yusuf nodded once, a very small nod, as if agreeing to something he'd been dreading for years.

"The signal is coming from its center," Mara continued. "Or at least, from somewhere deep inside it. The outer surface is — Yusuf, the outer surface isn't reflecting our sensor pings. It's absorbing them. We're getting a read only because enough bleed-through is escaping for the instruments to reconstruct a partial profile."

"How long has it been there?" Yusuf asked.

"I can't tell. But the gravitational shadow it's casting—" She pulled up a timeline and overlaid it on the navigation record. "This is your anomalous mass reading from eleven years ago."

He looked at it for a long time.

"It's been following us," he said.

The words arrived in the room quietly and then filled every corner of it.

Mara shook her head. "Not following. Pacing. It's been maintaining a constant distance of approximately 4.3 light-hours for at least eleven years. Maybe longer. We didn't pick it up earlier because we were never looking backward-oblique at that angle. No reason to."

"Until it moved."

"Until it moved," she confirmed. "Six hours and twenty minutes ago, it changed bearing and began closing the distance. That's when it started transmitting."

"It moved, and then it called out to us."

"Yes."

They were both quiet.

It is a particular kind of terror — not the sharp, loud terror of immediate danger, which at least comes with adrenaline and action and the merciful simplicity of run-or-fight. This was the slower kind. The kind that seeps in through the understanding rather than the senses. The kind you feel first as a coldness behind the sternum and only later recognize as the sudden, bone-deep awareness that the world is a great deal larger and stranger than you built your life around assuming.

Something had been out there in the dark.

It had been watching them for eleven years.
...
Specifically, it was in a form of English that the ship's linguistic dating algorithms placed at approximately 200 years old — early twenty-second century, pre-Departure era, the generation just before the colony ships launched. There were idioms she had to look up. The syntax felt slightly formal, the way old books felt formal. But it was unmistakably, completely, fully readable.

Yusuf read the transcript over her shoulder. Then he read it again. Then he sat down heavily on the edge of the monitoring console and stared at the floor.

The message was 847 words long. Mara had read it eleven times. She was going to read it eleven more.

It said, in essence, this:

We are the Caretakers.

We have been designated to accompany the human migration from the Sol system under a mandate issued by a collective of civilizations whose names would mean nothing to you, in response to an application for protected migration status filed on humanity's behalf by observers who had been monitoring your species for some time.

Under the terms of this mandate, we are prohibited from making contact during the migration transit except under specific circumstances: if the vessel falls below minimum population viability, if the vessel's course deviates beyond a specified threshold from a survivable destination, or if the vessel is about to make a catastrophic error.

You are about to make a catastrophic error.

The planet designated Kepler-442b in your records is no longer viable for settlement. It was viable when your mission was planned. It is no longer. A natural event of a kind your instruments cannot currently detect has rendered its atmosphere non-survivable within the last sixty years. We became aware of this 61 years ago. At that time, we calculated that alerting you would cause a psychological crisis that the ship's population was not equipped to survive at that stage of the journey. We waited for a better moment.

We have a better moment now.

There is a viable planet. It is 340 light-years off your current heading. We can guide you there. It is not the planet your ancestors chose for you. It is, in our assessment, better.

We understand that you will have questions. We understand that you will not immediately trust this message. We understand that some of you will believe it is a trap, a deception, a hallucination, or a test.

It is none of these things.

We have been with you since you left. We watched you grieve your dead ships. We watched your children grow up in recycled air and dream of a sky they had never seen. We watched you carry your history across the dark and tend it carefully so it would survive the crossing.

We want you to arrive.

We have always wanted you to arrive.
...
"Yes," said Yusuf. He was looking at his rolled-up map, leaning against the wall. He thought about the red circle. Eleven years of a careful man's quiet unease, validated in the strangest possible way. He thought about the fifth ship's message — Don't follow the light on the port side — and wondered if that crew had also been approached, and had misread the approach as a threat.

"She won't believe it," Mara said.

"She'll believe the signal exists. The rest she'll have to decide."

"And the passengers? All 14,000?"

"That," said Yusuf, "is what Captains are for."
...
When Mara and Yusuf walked into her office and Mara placed the transcript on her desk without saying a word, Nadia read it once, set it down, and looked out the small viewport behind her desk at the dark.

She sat with it for four full minutes. Mara counted.

Then she said: "Have you verified the signal is real and not an instrument artifact?"

"Seven times," said Mara.

"Have you verified the linguistic dating?"

"Cross-referenced against three independent databases."

"Do we have visual confirmation of the structure?"

"Partial. Enough."

Nadia nodded slowly. "Have you told anyone else?"

"No."

"Good." She stood up. She was not a tall woman but she had the quality, in moments like this, of taking up exactly the right amount of space. "I want full signal analysis on my desk in two hours. I want Yusuf's navigational assessment of the alternate heading in three. I want our population psychologist, Dr. Ferreira, in this office in one hour for a confidential consultation on disclosure strategy. And I want a response drafted — not sent, drafted — that neither confirms nor denies that we've received anything, that buys us 48 hours."

"To do what?" Mara asked.

Nadia looked at the transcript again. At the last line. We will wait. We are very good at waiting.

"To think," she said. "Something that has been out there for eleven years following a ship full of frightened people across the dark — not attacking, not revealing itself, just accompanying — deserves at least 48 hours of thinking before we say our first word to it."

She picked up the transcript. "And because — because whatever we say first, we say for all of us. All 14,000. All the dead ships. Everyone who ever looked up at the stars from Earth and wondered if there was anything looking back." She set it down again. "The first word matters."

Mara thought of her grandmother's voice. The transcript she'd read so many times she had memorized it. The way her grandmother had described the launch day — standing at a window, watching the last ship rise, thinking: I hope they find something beautiful.

"What will you say?" Mara asked.

Nadia almost smiled — a particular kind of smile, the kind made of equal parts weight and wonder.

"I'll say thank you," she said. "And then I'll say tell us about the planet."

She walked to the viewport and stood there looking out at the dark that was no longer quite as empty as it had seemed an hour ago. Somewhere out there, 4.3 light-hours away, something very old and very patient was listening.
...
Thank you for staying. Now tell us about the planet we're going to.

She released the transmit key.

The green line on Mara's old monitor — silent for eighteen hundred days — carried the words out into the dark at the speed of light.

And then, from 4.3 light-hours away, something that had been waiting for 214 years answered in 847 words of its own.

Nadia read every one.
...
Who is the person in your life that you have been geographically, emotionally, or silently absent from — and what would your four-sentence letter to them say right now, tonight, if you were brave enough to write it? Share in the comments. The only letters that never arrive are the ones that stay in your pocket.`
  ...
  image: "https://images.unsplash.com/photo-1759771716199-1194c6efe0c7?w=800&q=80",
cover: {
  image: "https://images.unsplash.com/photo-1759771716199-1194c6efe0c7?w=1920&q=80"
},
...
He almost stepped over it. A brown envelope, fat and unsealed, tucked halfway under the cracked rubber doormat outside their single room in Ajegunle. He thought it was a bill. God knows they had enough of those. He picked it up anyway — because the handwriting on the front stopped him cold.

It said: For Emeka. Use it wisely. Do not ask questions.

The handwriting was his father's.

His father had been buried three years ago.

He stood in the doorway so long that Mama Chidinma from the next room poked her head out and asked if he was sick. He said no. He went back inside. He sat on the edge of the bed where his mother usually slept, opened the envelope with shaking fingers, and counted.

Fifty thousand naira. All in clean, crisp notes.

He counted again.

Fifty thousand.

He thought: This is a mistake. Or a joke. Or I am still asleep.

Then his phone rang. It was Uncle Reuben. And the way Uncle Reuben said his name — soft, careful, like he was handling broken glass — Emeka knew.

He knew before a single word about his mother came out.

She had collapsed at the market at 4 a.m., they said. Heart. She was gone before the okada man who found her could do anything. She had gone to sell pepper and tomatoes the way she did every Tuesday and Friday, the way she had done for nineteen years since his father died, the way she swore she would keep doing until Emeka finished university and got a job that meant she could finally rest.

She never rested.

Emeka sat with the phone in his hand for a very long time after Uncle Reuben hung up. The fifty thousand naira sat on the bed beside him, fanned out in a neat half-circle, almost glowing in the grey morning light.

Do not ask questions.

He asked them anyway — silently, to a God and a dead father he was not sure were listening.

Where did this come from? Why today? Why now, when she is gone and I have nobody left?

No answer came. Outside, Ajegunle was already awake and loud and completely indifferent to the fact that his world had just ended.

He used the first ten thousand for the funeral.

He did not want to. He tried everything else first. He called his mother's cousin in Enugu — the one with the two cars — and was told that times were hard. He called three of her market friends, who came, cried loudly, and left without offering a kobo. He called his own friends, who sent prayers via WhatsApp.

So he used the money.

He paid for the white canopy and the plastic chairs. He bought rice and stew for fifty people. He paid the pastor who spoke for forty minutes about a woman he had met exactly twice.

The day after the burial, a man named Tobenna — who lived three streets away, a quiet man with a bad leg who sold provisions — collapsed in his shop and died.

Emeka did not connect these two things. Not yet.

He moved through the next two weeks the way a man moves underwater. Slow. Heavy. Like every small action — making tea, sweeping the floor, folding his mother's wrappers — cost him something he could not afford to keep spending.

His rent was due. His university clearance fee was due. He had not eaten a real meal in four days.

He looked at the forty thousand remaining in the envelope.

He thought about what his mother would say. She would say: Use your head, Emeka. That is what I suffered for.

So he used ten thousand for rent.

Two days later, Alhaji Musa — the landlord of the building beside theirs, a man so healthy people joked he would outlive the street itself — had a stroke. He died in the hospital on a Thursday morning.

Emeka's neighbour Mama Chidinma mentioned it over the fence. "So sudden," she said, shaking her head. "He was fine just last week."

Something small and cold moved through Emeka's chest.

He pushed it away.

Coincidence, he told himself. People die. That is the world.

He started writing it down.

He did not know why. Maybe it was the engineer in him — he was in his third year of electrical engineering before the money ran out — the part of him that could not see two data points without looking for a third.

He bought a small notebook from the kiosk. Blue cover. Fifty leaves.

He wrote:

10,000 – funeral expenses – Tobenna (provisions seller, 3 streets away) – died 1 day later.

10,000 – rent – Alhaji Musa (landlord, next building) – died 2 days later.

He stared at what he had written for a long time.

Then he told himself he was going mad with grief and closed the notebook.

He lasted six days before he opened it again.

Because on the fifth day, desperate, ashamed, he had taken five thousand from the envelope to buy food — just rice and eggs and groundnut oil, nothing extravagant — and on the sixth day, a woman named Sister Ngozi, who led the evening prayers at his mother's church, collapsed on the church steps and did not get up.

He wrote it down with a hand that would not stop shaking.

5,000 – food – Sister Ngozi (church, evening prayer leader) – died 1 day later.

Three transactions. Three deaths. All strangers. All within forty-eight hours.

He turned the envelope over in his hands. Looked at it from every angle as if the paper itself might confess something. The handwriting on the front stared back at him, patient and unbothered.

Do not ask questions.

"Papa," he whispered to the empty room. "What did you give me?"

He found Brother Emeka — not his own name, a coincidence he had always found mildly irritating — through his mother's church.

Brother Emeka was seventy-something. He had a face like crumpled leather and eyes that looked like they had personally witnessed several things they wished they had not. He was known in the area as someone who understood certain things — the kind of certain things that nobody wanted explained in daylight.

Our Emeka did not believe in those certain things. He was an engineer. He believed in circuits and load capacity and Ohm's Law.

He went to see the old man anyway, because the notebook had thirty thousand naira left on one side and three dead strangers on the other, and Ohm's Law had no formula for that.

They sat in Brother Emeka's front room. It smelled of camphor and old paper. A ceiling fan pushed hot air in slow circles.

"Show me," the old man said.

Our Emeka showed him the notebook.

Brother Emeka read it without expression. Read it again. Set it down on his knee and looked at the ceiling for a while.

"This money," he finally said. "Where did it come from?"

"An envelope. Under my door. The day my mother died."

"And the handwriting?"

A pause. "My father's."

Brother Emeka nodded slowly, the way people nod when something confirms what they already suspected and did not want confirmed.

"Your father was a good man?"

"He was."

"Did he owe anyone anything? When he died?"

Emeka opened his mouth. Closed it. Thought.

His father had died suddenly, yes. A road accident. He was thirty-nine. There had been — Emeka remembered this vaguely, a child's half-understanding — some trouble. Some money that was supposed to go somewhere and did not. A business partner who came to the house twice after the burial, speaking quietly to his mother in the kitchen.

"I don't know," he said honestly. "Maybe."

Brother Emeka laced his fingers together. "What I am about to tell you," he said, "your university will never teach you. But it is true."

There is money that moves through the world with a debt already attached to it. Sometimes it is money connected to a promise broken in death — a man who owed and could not pay before he left, whose obligation did not dissolve with his body but moved into the world looking for settlement. The money finds its way to someone connected to the debtor. And when it is spent, the debt is extracted — not from the spender, but from whoever is nearest, whoever is most available, whoever the universe decides is the substitute.

"You are not killing anyone," the old man said, and his voice was very calm. "But you are the instrument by which a debt is being paid. Every time that money leaves your hand, life leaves someone else's."

Emeka stared at him.

"So what do I do?" he asked. "I still have thirty thousand left. I cannot just not spend it."

"You can give it back."

"To who? My father is dead."

"Then burn it."

He did not burn it.

He was ashamed of that later. But that night, sitting with thirty thousand naira and an empty stomach and a rent that was already one month behind, he told himself he needed more time. He needed to think. He needed to be sure the old man wasn't just a superstitious relic telling ghost stories to a grieving boy.

He needed to eat.

So he told himself: Just this once. Just enough to get through the week. I'll burn the rest after.

He spent three thousand on food.
...
He thought: Maybe I was wrong. Maybe it was all coincidence after all.

Day three, his best friend Chukwuemeka — Chucks, who had been his roommate in their first year before Emeka dropped out, who had visited him after the funeral and brought him a bag of rice and sat with him in silence because he didn't know what else to do — Chucks was involved in a road accident.

He didn't die.

But he lost his left hand.

Emeka sat beside Chucks in the hospital. Chucks was sedated, his arm ending at the wrist in a thick white bandage. His mother sat across the room crying into a handkerchief.

Emeka looked at his friend's face, slack and trusting in sleep, and felt something break open inside him that he did not have a name for.

Not guilt. Guilt was too small a word.

Something older. Something that pressed against the inside of his ribs like it wanted out.

He had done this. Not with his hands. Not with intention. But he had done it.

He left the hospital without speaking to Chucks's mother. He walked home through streets that had never felt so loud and so merciless. He went into his room and took the envelope from under the mattress.

Twenty-seven thousand naira. He counted it three times as if the number might change.

He thought about what the old man had said.

Burn it.

He thought about his university fees. About the course he had loved, the future he had imagined, the version of himself that his mother had worked nineteen years of 4 a.m. market runs to make possible.

He thought about Chucks's left hand, which would never hold a pen again, never fix a car engine again, never wave at him from across a compound again.

He took the envelope outside.

He burned it in the backyard, in the rusty metal drum they used for burning rubbish.

He watched every note catch, and blacken, and curl at the edges, and become nothing.

Twenty-seven thousand naira. Gone. The last thing his father had ever given him — if it even was his father — turned to ash and smoke in an Ajegunle backyard while a generator droned somewhere on the next street and a child cried and someone's radio played an old Oliver De Coque song.

He didn't cry.

He had used up all his crying. He stood and watched until there was nothing left but black flakes and the smell of it.

Then he went back inside.

Three things happened in the month that followed.

The first: nobody died. Nobody collapsed. Nobody lost anything. The pattern stopped so completely that it felt like a held breath finally released.

The second: Chucks recovered enough to leave the hospital. He came to see Emeka one afternoon, his arm still in a sling, his eyes a little different now — quieter, like a man who had been somewhere and come back changed. He didn't ask Emeka why he hadn't visited again. He just sat down and asked for water, and they talked for two hours about nothing important, the way they used to.

Emeka almost told him. He opened his mouth three times.

He closed it three times.

Some things, he decided, were not fair to hand to another person.

The third thing: he found a job. A small engineering firm on the mainland. Entry-level, badly paid, with a boss who spoke too loudly and air conditioning that only worked on Tuesdays. He started on a Monday. He took a bus at 5:30 a.m. He wore his one good shirt.

It was not the life he had imagined.

It was a life.

He went back to see Brother Emeka one last time.

The old man was in his garden, of all things, pruning something with a small pair of scissors, moving slowly but with great precision.

"It's done?" the old man asked without turning around.

"Yes."

"Good."

Emeka stood in the gate for a moment. "Were they really connected?" he asked. "The money and the deaths? Or was I just looking for patterns because I was grieving and my brain needed something to make sense of?"

Brother Emeka turned around then. He looked at Emeka for a long time.

"Does it change anything?" he asked. "What you would have done, if you knew for certain one way or the other?"

Emeka thought about it. Really thought.

"No," he said quietly. "I don't think it does."

The old man turned back to his garden. "Then you already have your answer."

He keeps the blue notebook.

Not to read — he never reads it. But he keeps it in the drawer beside his bed, under a copy of his HND certificate and a photograph of his mother at the market, laughing at something off-camera, her headtie slightly crooked.

He doesn't know, with absolute certainty, what the money was. He doesn't know if his father's ghost somehow placed an envelope under a doormat. He doesn't know if the universe is structured in a way that allows debts to survive death and seek payment through the living.

He is an engineer. He is supposed to know things for certain.

What he knows is this:

Three thousand naira bought him a week of food and cost his best friend a hand.

What he knows is: his mother died in the dark at 4 a.m., alone, carrying tomatoes, so he could have a future.

What he knows is: the only money that has ever made him sleep peacefully is the money he earned at 5:30 a.m., standing on a bus, in a shirt he ironed himself.

Everything else — the envelope, the handwriting, the ash in a metal drum — he has placed in the same category he places all the things he cannot explain and cannot afford to carry forever.

He placed them down.

He kept walking.

Some nights, before he sleeps, he thinks he can still smell the smoke.

He checks the drawer.

The notebook is always there.

And the photograph of his mother is always laughing.`,

    // ── SEO METADATA ──
    seo: {
      metaTitle: 'The Boy Who Paid With Tomorrow | Laminono Nexus — Free Short Stories',
      metaDescription: 'Read "The Boy Who Paid With Tomorrow" — a gripping Nigerian drama about cursed money, grief, and the price of survival. Free short story by Olamide Emmanuel Willoughby.',
      metaKeywords: 'Nigerian short stories, African fiction, free stories online, drama stories, cursed money, grief fiction, Lagos stories, Ajegunle, Olamide Willoughby, Laminono Nexus',
      ogTitle: 'The Boy Who Paid With Tomorrow — A Story That Haunts You',
      ogDescription: 'Every note he spent carried a price. He just did not know who was paying it. A gripping Nigerian drama about cursed money and impossible choices.',
      ogImage: 'https://images.unsplash.com/photo-1515549832467-8783363e19b6?w=1200&q=80',
      twitterCard: 'summary_large_image',
      canonicalUrl: 'https://laminono-nexus.github.io/?story=the-boy-who-paid-with-tomorrow',
...
function resetToHomeSEO() {
  ...
  updateMetaTag('og:image', 'https://images.unsplash.com/photo-1515549832467-8783363e19b6?w=1200&q=80');
